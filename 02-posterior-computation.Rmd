...
\begin{equation}
\sigma^2_\theta| \bgL, \tau^2_\theta, \bgTh, \xi_p \stackrel{ind.}{\sim} IG \left(\frac{1}{2} + \frac{\sum_{p<p'}\xi_p\xi_{p'}}{2}, \frac{1}{\kappa_{\sigma^2_\theta}} + \frac{1}{2 \tau^2_\theta} \sum_{p<p'}\frac{\xi_p\xi_{p'}\theta_{p,p'}^2}{\lambda^2_{p,p'}} \right)
(\#eq:horseshoeSigma)
\end{equation}
...
\begin{equation}
\eta^2_p| \bgPh, \tau^2_\beta, \bB, \xi_p \stackrel{ind.}{\sim} IG \left(\frac{1}{2} + \frac{V_p \xi_p}{2}, \frac{1}{\kappa_{\eta_P}} + \frac{\xi_p}{2 \tau^2_\beta} \sum_{\substack{v=1}}^{V_p}\frac{\beta_{v,p}^2}{\phi^2_{v,p}} \right) \quad p \in \{1,\ldots,P\}
(\#eq:horseshoeEta)
\end{equation}
